...
const ShopShoeDetail = () => {
  ...
  return (
    <motion.div
      className="size-full flex flex-col overflow-y-scroll max-lg:overflow-y-visible"
      key={`${selectedShoe}`}
    >
      ...
      <div className="relative px-5 flex items-start justify-between max-md:flex-col bg-s z-10">
        <div className="sticky top-0 w-full flex-[1.5] pt-6 pr-4 border-r max-lg:border-none border-bb flex flex-col items-start justify-start max-md:px-0 max-md:relative">
        ...
        <div className="flex-[2.5] pt-6 pl-4  flex flex-col h-full pr-2 max-md:px-0">
          ...
          <div className="mb-1 h-fit overflow-hidden">
            ...
            >
              SIZE:
              <span className="text-t font-bold">{selectedSize || "None"}</span>
            </motion.p>
          </div>
          <div className="mb-1 h-fit overflow-hidden">
            <motion.p
          ...
          <div className="mb-[75px] h-fit overflow-hidden">
            ...
            >
              ...
              unit. It gives you and the sport's fastest players the propulsive
              feel needed to break through the back line. The result is the most
              responsive Mercurial we've ever made, because you demand greatness
              from yourself and your footwear.
            </motion.p>
          </div>
