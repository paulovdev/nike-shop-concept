...
const Shop = () => {
  ...
  return (
    <motion.div className="size-full px-5 py-5 flex flex-col items-start justify-start">
      ...
      <div className="relative mb-8 w-full h-[50px] flex items-center justify-between z-50 ">
        <div className="w-full ">
          <div className="h-fit overflow-hidden">
            <motion.h2
              className="text-[18px] text-t font-bold uppercase flex items-center gap-4"
              variants={textSlideSingleAnimation}
              initial="initial"
              animate="animate"
              custom={0.05}
            >
              <SiNike className="text-t" size={38} />
              {selectedFilter?.category || "All"} ({filtered.length})
            </motion.h2>
          </div>
        </div>
      ...
      <div
        className="size-full grid grid-cols-4 gap-4 max-fl:grid-cols-4 max-lg:grid-cols-4 max-md:grid-cols-3"
        ...
        {filtered.map((item) => (
          ...
          >
            ...
            <div className="h-fit flex flex-col items-start justify-end">
              ...
              <div className="mb-1 h-fit overflow-hidden relative z-10">
                <motion.h2
                  className="text-[12px] text-t font-bold uppercase"
                  variants={slideUpWExitAnimation}
                  initial="initial"
                  animate="animate"
                  exit="exit"
              ...
              <div className="mb-1 h-fit overflow-hidden relative z-10">
                <motion.p
                  className="text-[10px] text-t/75 font-medium uppercase"
                  variants={slideUpWExitAnimation}
                  initial="initial"
                  animate="animate"
                  exit="exit"
